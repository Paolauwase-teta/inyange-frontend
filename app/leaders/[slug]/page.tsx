    ...
    <main className="min-h-screen bg-[#f8fafc] text-[#0d55a0] font-sans overflow-hidden selection:bg-[#33a4df]/20 selection:text-[#0d55a0]">
      ...
      <nav className="fixed top-24 left-8 right-8 z-50 flex justify-between items-center">
          ...
          >
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[#0d55a0]/70 group-hover:text-[#0d55a0] transition-colors">Back to Matrix</span>
          </motion.button>
      ...
      <section className="relative z-10 pt-52 pb-32 px-8 max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-7 space-y-16">
            ...
            >
              <h1 className="text-6xl md:text-[7rem] font-black uppercase tracking-tighter leading-[0.85] mb-8 text-[#0d55a0]">
                {leader.name}<span className="text-[#33a4df]">.</span>
              </h1>
              
              <div className="flex flex-wrap items-center gap-6 mb-12">
                  <div className="px-6 py-3 border border-[#33a4df]/30 bg-[#33a4df]/5 text-[#33a4df] rounded-xl text-xs font-black uppercase tracking-widest">
                      {leader.title}
                  </div>
                  <div className="flex gap-4">
                    {leader.socialLinks.linkedin && (
                      <a href={leader.socialLinks.linkedin} className="w-12 h-12 rounded-2xl bg-white border border-zinc-100 shadow-sm flex items-center justify-center text-[#0d55a0] hover:bg-[#0d55a0] hover:text-white transition-all transform hover:-translate-y-1">
              ...
              <div className="relative pl-12 border-l-[1rem] border-[#33a4df]/20">
                  <p className="text-[#0d55a0]/70 font-bold leading-[1.8] text-xl md:text-2xl tracking-tight max-w-2xl italic">
                    "{leader.bio}"
                  </p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-6">
                <h3 className="text-2xl md:text-4xl font-black uppercase tracking-tighter text-[#0d55a0]">Governance <br/> Track Record</h3>
              ...
              <div className="grid grid-cols-1 gap-6">
                {leader.experiencePoints.map((point, index) => (
                  <motion.div 
                    ...
                    className="flex items-start gap-8 bg-white/60 backdrop-blur-3xl p-8 rounded-[2rem] border border-[#0d55a0]/5 hover:border-[#33a4df]/20 transition-all group shadow-sm hover:shadow-xl"
                  >
                    <div className="flex-shrink-0 pt-1">
                      <div className="w-10 h-10 rounded-xl bg-[#33a4df]/10 flex items-center justify-center text-[#33a4df] group-hover:bg-[#33a4df] group-hover:text-white transition-all">
                        <CheckCircle2 className="w-5 h-5" />
                      </div>
                    </div>
                    <p className="text-[#0d55a0]/60 font-bold text-sm md:text-base leading-relaxed">
                      {point}
                    </p>
                  </motion.div>
                ))}
