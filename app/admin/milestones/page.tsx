        ...
        <>
            ...
            <div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    ...
                    <button onClick={openCreate} style={{ padding: '10px 20px', background: '#0d55a0', color: '#fff', border: 'none', borderRadius: '10px', fontSize: '12px', fontWeight: 700, cursor: 'pointer' }}>+ New Milestone</button>
                </div>
                                ...
                                : milestones.length === 0 ? <tr><td colSpan={5} style={{ padding: '40px', textAlign: 'center', color: 'rgba(0,0,0,0.3)' }}>No milestones yet.</td></tr>
                                    : milestones.map(m => (
                                        <tr key={m.id} style={{ borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
                                            ...
                                            <td style={{ padding: '12px 16px', fontSize: '13px', fontWeight: 600, color: '#0d55a0' }}>{m.title}</td>
